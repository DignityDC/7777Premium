...
Config.BlacklistedWeapons = { "WEAPON_RAILGUN", "WEAPON_GARBAGEBAG", "WEAPON_SNSPISTOL_MK2","WEAPON_FLAREGUN","WEAPON_REVOLVER_MK2", "WEAPON_DOUBLEACTION", "WEAPON_SMG_MK2","WEAPON_RAYCARBINE", "WEAPON_SAWNOFFSHOTGUN","WEAPON_DBSHOTGUN", "WEAPON_AUTOSHOTGUN", "WEAPON_ASSAULTRIFLE_MK2", "WEAPON_CARBINERIFLE_MK2","WEAPON_SPECIALCARBINE_MK2","WEAPON_BULLPUPRIFLE_MK2","WEAPON_MG", "WEAPON_COMBATMG", "WEAPON_COMBATMG_MK2","WEAPON_HEAVYSNIPER_MK2", "WEAPON_MARKSMANRIFLE", "WEAPON_MARKSMANRIFLE_MK2", "WEAPON_RPG","WEAPON_GRENADELAUNCHER_SMOKE", "WEAPON_MINIGUN","WEAPON_RAILGUN", "WEAPON_HOMINGLAUNCHER","WEAPON_RAYMINIGUN","WEAPON_PROXMINE", "WEAPON_SNOWBALL", "WEAPON_PIPEBOMB","WEAPON_SMOKEGRENADE", "WEAPON_ROCKET", "WEAPON_EXPLOSION ", "WEAPON_FLARE", "WEAPON_MUSKET" }
